...
const Project = () => {
    ...
    const send = () => {
        ...
        // console.log("Message sent and user._id:", message, user);
    ...
    useEffect(() => {
        ...
        // console.log('initializeSocket Id :', project._id);
        socket.on('connect', () => {
        ...
        axios.get('/users/all', {
            ...
            console.log("users-all :", res.data.users);
    ...
    //             console.log(err);
    //         })
    //     console.log('Making request to /users/all'); // Add logging
    //     axios.get('/users/all').then(res => {
    //         console.log('Received response from /users/all'); // Add logging
    //         setUsers(res.data.users)
    //         console.log("users/all datas", res.data.users);
